...
| ID | Action | Findings | Sprint | Evidence to close | Owner | Status |
| --- | --- | --- | --- | --- | --- | --- |
| LC-3.1 | Password recovery flow | ORG-PR-004 | 17 | reset integration tests (expiry/reuse/enum) | Eng | Open |
| LC-3.2 | Email verification + register de-enumeration | ORG-PR-024, 030 | 16/17 | verification tests; no register oracle | Eng | Open |
